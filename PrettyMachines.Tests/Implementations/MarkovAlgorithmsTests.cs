...
public class MarkovAlgorithmsTests(ITestOutputHelper output) : BaseAlgorithmTest(output)
{
    ...
    {
        var algorithm = MarkovAlgorithms.Create_BinaryAddition();
    ...
    {
        var algorithm = MarkovAlgorithms.Create_BinarySubtraction();
    ...
    {
        var algorithm = MarkovAlgorithms.Create_StringConcatenation();
    ...
    {
        var algorithm = MarkovAlgorithms.Create_BusyBeaver();
    ...
    {
        var algorithm = MarkovAlgorithms.Create_BinaryToUnaryConverter();
    ...
    {
        var algorithm = MarkovAlgorithms.Create_DecimalToBinaryConverter();
    ...
    {
        var algorithm = MarkovAlgorithms.Create_BinaryToDecimalConverter();
    ...
    {
        var algorithm = MarkovAlgorithms.Create_StringReversal();
    ...
    {
        var algorithm = MarkovAlgorithms.Create_StringReversal("01");
